...
namespace BackEnd_Api.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InitialResponses",
                columns: table => new
                {
                    InitialResponseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CaseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DispatchTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PreliminaryAssessment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InitialResponses", x => x.InitialResponseId);
                    table.ForeignKey(
                        name: "FK_InitialResponses_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "CaseId",
            ...
            migrationBuilder.CreateTable(
                name: "MedicalRescueSupports",
                columns: table => new
                {
                    MedicalRescueSupportId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SupportType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PersonelAssigned = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalRescueSupports", x => x.MedicalRescueSupportId);
                    table.ForeignKey(
                        name: "FK_MedicalRescueSupports_InitialResponses_InitialResponseId",
                        column: x => x.InitialResponseId,
                        principalTable: "InitialResponses",
                        principalColumn: "InitialResponseId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ScenePreservationMeasures",
                columns: table => new
                {
                    ScenePreservationMeasureId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ResponsibleOfficerUserName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    InitialResponseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProtectionMethods = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AreaCovered = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenePreservationMeasures", x => x.ScenePreservationMeasureId);
                    table.ForeignKey(
                        name: "FK_ScenePreservationMeasures_InitialResponses_InitialResponseId",
                        column: x => x.InitialResponseId,
                        principalTable: "InitialResponses",
                        principalColumn: "InitialResponseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScenePreservationMeasures_Users_ResponsibleOfficerUserName",
                        column: x => x.ResponsibleOfficerUserName,
                        principalTable: "Users",
                        principalColumn: "UserName",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MedicalRescueSupportAttachments",
                columns: table => new
                {
                    MedicalRescueSupportAttachmentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MedicalRescueSupportId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalRescueSupportAttachments", x => x.MedicalRescueSupportAttachmentId);
                    table.ForeignKey(
                        name: "FK_MedicalRescueSupportAttachments_MedicalRescueSupports_MedicalRescueSupportId",
                        column: x => x.MedicalRescueSupportId,
                        principalTable: "MedicalRescueSupports",
                        principalColumn: "MedicalRescueSupportId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ScenePreservationMeasureAttachments",
                columns: table => new
                {
                    ScenePreservationMeasureAttachmentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScenePreservationMeasureId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenePreservationMeasureAttachments", x => x.ScenePreservationMeasureAttachmentId);
                    table.ForeignKey(
                        name: "FK_ScenePreservationMeasureAttachments_ScenePreservationMeasures_ScenePreservationMeasureId",
                        column: x => x.ScenePreservationMeasureId,
                        principalTable: "ScenePreservationMeasures",
                        principalColumn: "ScenePreservationMeasureId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InitialResponses_CaseId",
                table: "InitialResponses",
                column: "CaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRescueSupportAttachments_MedicalRescueSupportId",
                table: "MedicalRescueSupportAttachments",
                column: "MedicalRescueSupportId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRescueSupports_InitialResponseId",
                table: "MedicalRescueSupports",
                column: "InitialResponseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScenePreservationMeasureAttachments_ScenePreservationMeasureId",
                table: "ScenePreservationMeasureAttachments",
                column: "ScenePreservationMeasureId");

            migrationBuilder.CreateIndex(
                name: "IX_ScenePreservationMeasures_InitialResponseId",
                table: "ScenePreservationMeasures",
                column: "InitialResponseId");

            migrationBuilder.CreateIndex(
                name: "IX_ScenePreservationMeasures_ResponsibleOfficerUserName",
                table: "ScenePreservationMeasures",
                column: "ResponsibleOfficerUserName");
