        ...
        <div className="statement-main">
            ...
            <Form onSubmit={handleSubmit(handleFormSubmit)}>
                        ...
                        <Row>
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    />
                                    {errors.initialName && (
                                        <small className="text-danger">{errors.initialName.message}</small>
                                    )}
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                ...
                                <Form.Group>
                                    ...
                                    <Form.Control
                                        ...
                                        {...register("contact", {
                                            ...
                                            pattern: {
                                                value: /^\+\d{10,15}$/,
                                                message: "Must start with '+' and be 10–15 digits long",
                                            },
                                        })}
                                    />
                                    {errors.contact && (
                ...
                <div className="statement-box">
                    ...
                    <div className="section-content">
                        <Form.Label className="sub-label">Content of the Statement</Form.Label>
                        <Form.Control
                            as="textarea"
                            rows={6}
                            {...register("content", {
                ...
                <div className="statement-box">
                    ...
                    <div className="file-grid mt-3">
                        {[...(initialData?.files || []), ...uploadedFiles].map((file, idx) => (
                ...
                {/* Actions */}
                <div className="statement-actions mt-4 d-flex justify-content-end gap-2">
